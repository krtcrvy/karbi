          ...
          <div className="mx-auto mb-16 max-w-screen-sm text-center lg:max-w-screen-md">
            ...
            <BlurFade delay={0.5} inView>
              <p className="text-base text-muted-foreground md:text-lg lg:text-xl">
                Take a look at some of my recent projects, where innovation
                meets impact. Each one tells a story of problem-solving,
                creativity, and technical expertise.
              </p>
            </BlurFade>
          </div>

          <BlurFade delay={0.75} className="flex flex-col gap-8">
            <ProjectsSkeleton />
          </BlurFade>
        </div>
      </section>

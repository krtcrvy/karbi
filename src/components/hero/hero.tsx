    ...
    <section>
      <div className="py-32 px-4 mx-auto max-w-screen-xl text-center lg:px-12">
        <div className="flex flex-col items-center">
          ...
          />
          <div className="border px-4 py-1.5 inline-flex rounded-lg items-center gap-4 mb-8">
          ...
          <div className="max-w-screen-md">
            ...
            <h1 className="mb-4 font-bold text-5xl lg:text-6xl font-serif">
              Kurt Carvey Cadenas
            </h1>

            <p className="mb-8 font-bold text-4xl lg:text-5xl font-serif">
